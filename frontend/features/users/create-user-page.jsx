...
export function CreateUserPage({ navigation, dojoOptions }) {
  return (
    <SiteShell navigation={navigation}>
        ...
        <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-relaxed text-app-text-secondary">
              Buat akun admin dojo atau super admin, lalu atur status aktif, verifikasi, dan metadata keamanan.
            </p>
          </div>
      ...
      <CreateUserForm dojoOptions={dojoOptions} redirectTo={ROUTES.users} />
    </SiteShell>
  );
}
