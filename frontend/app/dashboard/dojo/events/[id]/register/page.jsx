import { DojoEventDetailPage } from "@/features/dojo-dashboard/dojo-event-detail-page";
import { getDojoEventDetailPageData } from "@/features/dojo-dashboard/dojo-event-detail-page-data";

export const dynamic = "force-dynamic";

export default async function DojoEventRegistrationPageRoute({ params }) {
  ...
  return <DojoEventDetailPage navigation={pageData.navigation} event={pageData.event} />;
}
